...
```bash
doctor-devctl --manager http://127.0.0.1:17002 --token yaNtOybPhroLdMnuRi0Dg8yE status
doctor-devctl --manager http://127.0.0.1:17002 --token yaNtOybPhroLdMnuRi0Dg8yE inbounds Forigen-Node-Group-1
```
